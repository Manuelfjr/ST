...
\qquad A série utilizada contempla o périodo de 26 de fevereiro até o último dia atualizado sobre o conjunto de dados, sendo atualizado diariamente Iremos contemplar dos dia 26 de fevereiro de 2020 até 24 de abril de 2021. Ao analisarmos a série, podemos observar uma queda no número de confirmados entre os periodos de agosto a outubro de 2020, evidenciado pelo possivel resultado da criação da lei Nº 14.046, de 24 de agosto de 2020, onde fica explicito o adiamento e cancelamento de serviços, de reservas e de eventos dos setores de turismo e de cultura, em função do estado de calamidade publica, reconhecida pelo Decreto Legislativo nº 6, de 20 de março de 2020, e da emergência de saúde pública de importância internacional decorrente da pandemia da Covid-19.   
...
\qquad Ao considerarmos tanto o teste de de Phillips Perron quanto o de Dickey Fuller, tomando um nível de significância de 5%, temos que para ambos é possivel notar um p-valor menor que o nivel de significância, respectivamente equivalentes a 0.01 e 0.000867, ou seja, rejeitamos a hipótese nula de que a série é não estácionaria (Testamos se $\phi = 1$, sobre $h_{0}$), ou seja, há evidência suficientes parar afirmar que a série temporal do número de casos de COVID-19 confirmados diariamente é estácionaria.
